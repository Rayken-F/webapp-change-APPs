/* RC31.18 / IQC-UI1-20260927. Loaded before intake/legacy click handlers. */
(function(){
  "use strict";
  const BUILD="RC31.18 / IQC-UI1-20260927",DB="ds_iqc_image_rc_v1",ACTIVE="ds_iqc_image_rc_active_batch";
  ...
  function installUi(){
    ...
    const heading=panel.querySelector(".iqc-rc-top h2");if(heading&&heading.textContent!=="📷 Honeywell 影像 RC31.18")heading.textContent="📷 Honeywell 影像 RC31.18";
