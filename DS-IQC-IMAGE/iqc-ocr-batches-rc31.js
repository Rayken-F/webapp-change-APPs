...
(function(){
  "use strict";
  const controller=window.__DS_IQC_RC31,$=id=>document.getElementById(id),active=()=>localStorage.getItem(window.IqcProduction.key("ds_iqc_image_rc_active_batch"));
