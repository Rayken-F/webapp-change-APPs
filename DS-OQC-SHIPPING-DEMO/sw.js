'use strict';
const CACHE='oqc-shipping-demo-20260914-history-h1';
const BASE=new URL('./',self.location.href).href;
const FILES=['./','index.html','history-h1.js?v=20260914-history-h1','domain.js?v=20260909-demo01','storage.js?v=20260909-demo01','app.js?v=20260910-real-entry01','style.css?v=20260909-demo01'];
