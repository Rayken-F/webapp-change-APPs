'use strict';
const CACHE='oqc-shipping-demo-20260910-01';
const BASE=new URL('./',self.location.href).href;
const FILES=['./','index.html','domain.js?v=20260909-demo01','storage.js?v=20260909-demo01','app.js?v=20260910-recovery01','style.css?v=20260909-demo01'];
